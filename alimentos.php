	...
	<header>
		...
		<main role="main">
		  <section id="alime">
			  	...
			  	<h3 class="tit text-center">Doe Alimentos ao Lar dos Velhinhos:</h3>
			  	<div class="linha2"></div><br>
			    <div class="container">
			      <div class="row">
			        <div class="col-md-4">
			          <div class="card mb-4 shadow-sm">
			            <img src="img/crate-delicious-food-709817.jpg" class="bd-placeholder-img card-img-top" focusable="false" role="img"></img>
			            <div class="card-body">
			              <h4 class="card-text"><b>Frutas</b></h4>
			              <p class="card-text">Variados tipos de frutas, incluindo melancia, maçã, mamão e banana.</p>
			              <div class="d-flex justify-content-between align-items-center">
			                ...
			                <small class="card-text">R$ 50,00</small>
			              </div>
			            </div>
			          </div>
			        </div>
			        <div class="col-md-4">
			          <div class="card mb-4 shadow-sm">
			            <img src="img/assorted-broccoli-cabbage-1300972.jpg" class="bd-placeholder-img card-img-top" focusable="false" role="img"></img>
			            <div class="card-body">
			              <h4 class="card-text"><b>Legumes</b></h4>
			              <p class="card-text">Variados tipos de legumes, incluindo cenoura, batata, abóbora e chuchu.</p>
			              <div class="d-flex justify-content-between align-items-center">
			                <div class="btn-group">
			                  <button type="button" class="btn btn-sm btn-outline-secondary card-text"><img src="img/dollar.png" title='Doar dinheiro'></button>
			                </div>
			        ...
			        <div class="col-md-4">
			          <div class="card mb-4 shadow-sm">
			            <img src="img/bebida-biscoitos-de-chocolate-caneca-1931444.jpg" class="bd-placeholder-img card-img-top" focusable="false" role="img"></img>
			            <div class="card-body">
			              <h4 class="card-text"><b>Bebidas</b></h4>
			              <p class="card-text">Variados tipos de bebidas, incluindo água, leite, sucos e chás.</p>
			              <div class="d-flex justify-content-between align-items-center">
			                <div class="btn-group">
			                  <button type="button" class="btn btn-sm btn-outline-secondary card-text"><img src="img/dollar.png" title='Doar dinheiro'></button>
			                  <button type="button" class="btn btn-sm btn-outline-secondary card-text"><img src="img/food.png" title='Doar alimentos'></button>
			                </div>
			        ...
			        <div class="col-md-4">
			          <div class="card mb-4 shadow-sm">
			            <img src="img/alimento-arroz-aveia-1166387.jpg" class="bd-placeholder-img card-img-top" focusable="false" role="img"></img>
			            <div class="card-body">
			              <h4 class="card-text"><b>Não perecíveis</b></h4>
			              <p class="card-text">Variados tipos de não perecíveis, incluindo arroz, feijão, sal e açúcar.</p>
			              <div class="d-flex justify-content-between align-items-center">
			                <div class="btn-group">
			                  <button type="button" class="btn btn-sm btn-outline-secondary card-text"><img src="img/dollar.png" title='Doar dinheiro'></button>
			                  <button type="button" class="btn btn-sm btn-outline-secondary card-text"><img src="img/food.png" title='Doar alimentos'></button>
			        ...
			        <div class="col-md-4">
			          <div class="card mb-4 shadow-sm">
			            <img src="img/acem-alimento-bife-1539684.jpg" class="bd-placeholder-img card-img-top" focusable="false" role="img"></img>
			            <div class="card-body">
			              <h4 class="card-text"><b>Carnes e Massas</b></h4>
			              <p class="card-text">Variados tipos de proteínas, incluindo carnes, frango, peixes, ovos e massas.</p>
			              <div class="d-flex justify-content-between align-items-center">
			                <div class="btn-group">
			                  <button type="button" class="btn btn-sm btn-outline-secondary card-text"><img src="img/dollar.png" title='Doar dinheiro'></button>
			                </div>
			                <small class="card-text">R$ 60,00</small>
			              </div>
			            </div>
			          </div>
			        </div>
			        <div class="col-md-4">
			          <div class="card mb-4 shadow-sm">
			            <img src="img/bread-coffee-cuisine-374052.jpg" class="bd-placeholder-img card-img-top" focusable="false" role="img"></img>
			            <div class="card-body">
			              <h4 class="card-text"><b>Outros</b></h4>
			              <p class="card-text">Inclui queijo, presunto, requeijão e biscoitos.</p>
			              <div class="d-flex justify-content-between align-items-center">
			                <div class="btn-group">
			                  <button type="button" class="btn btn-sm btn-outline-secondary card-text"><img src="img/dollar.png" title='Doar dinheiro'></button>
			                </div>
			                <small class="card-text">R$ 25,00</small>
			              </div>
			            </div>
			          </div>
			        </div>
