...
<body id="home">
	<header>
		...
		<main>
			<div class="a" data-ride="carousel">
			  <div class="carousel-inner">
			    <div class="carousel-item active">
			        <img class="painel d-block w-100" src="img/img52.jpg">
			    </div>
			  </div>
			</div>
		</main>
		<main class="pos">
		<section class="container3 text-center">
				<div class="col-sm" id="card1">
				      Doar faz bem ao <img src="img/heart-shape-silhouette.png" width="30px" height="30px">
				    </div>
				    <div class="col-sm" id="card2">
				      Escolha os itens e a quantidade que lhe convier para doar.
				    </div>
				    <div class="col-sm" id="card3">
				      Com alguns cliques você <br>melhora a vida de alguém!
				    </div>
			...
			<section class="container4">
				<div class="banner1">
		      		<div class="quad">
		      			<img src="img/img18.jpg" class="img1">
		      		</div>
		      		<div class="quad1">
		      			<h3>QUEM SOMOS?</h3>
		      			<div class="linha2"></div>
		      			<p>Trabalhamos como uma plataforma que serve como ponte para que voluntários possam fazer doações a Lares de Idosos sem a necessidade de sair de casa.</p>
		      		</div>
		      	</div>
		      	<hr>
		      	<div class="banner1">
		      		<div class="quad2" id="top">
		      			<h3>COMO FUNCIONA?</h3>
		      			<div class="linha2"></div>
		      			<p>O voluntário acessa a página, escolhe os itens e a quantidade que deseja doar. Logo após, é feita a soma do
		      			valor dos objetos selecionados, e a pessoa irá transferir o dinheiro à associação. O dinheiro doado será para
		      			compra exclusiva dos itens ao qual foi direcionado.</p>
		      		</div>
		      		<div class="quad3">
		      			<img src="img/img14.jpg" class="img2">
		      		</div>
		      	</div>
		      	<hr>
		      	<div class="banner1">
		      		<div class="quad">
		      			<img src="img/img8.jpg" class="img1">
		      		</div>
		      		<div class="quad1">
		      			<h3>O QUE BUSCAMOS?</h3>
		      			<div class="linha2"></div>
		      			<p>Nosso objetivo é ajudar os idosos da comunidade que moram em lares e ONG's. Facilitando as doações,
		      			buscamos incentivar os doadores e cativar novos voluntários, estimulando a solidariedade social.</p>
		      		</div>
		      	</div>
		      	<br>
			...
			<section class="container7"><br>
				<section class="container5 text-center">
					<div id="banner4">
						<div id="frase">
			      			<h1 class="text-white">A sorte de uns é a doação de outros!<h1>
			      		</div>
			      	</div>
				</section><br>
			</section>	
